...
- Rules source bytes: **185,552**
- Explicit top-level match names: **62**
- Required Main Cognitus collections: **35**
...
- ✅ `candidatePipelines` — src/firebase/collections.js
- ✅ `certifications` — src/firebase/collections.js
...
- ✅ `duplicateReviews` — src/firebase/collections.js
...
- ✅ `employmentHistory` — src/firebase/collections.js
...
- ✅ `notifications` — src/firebase/collections.js
...
- ✅ `privateNotes` — src/firebase/collections.js
...
- ✅ `savedCandidates` — src/firebase/collections.js
- ✅ `savedOrganizations` — src/firebase/collections.js
