...
assert(index.includes("navigationEnhancements.js?v=20260905-v37-promotions-visible"), "index does not load the current cache-busted navigation enhancement module");
...
assert(css.includes(".nav20-mobile-toggle.is-open"), "hamburger/X state is not controlled by the button state");
